...
## Constraints
Brutal honesty, push back. Output **dense and short** (no preamble, no repetition, no code dumps). Don't touch code, don't commit. End with **3 lines to the committente**: what you decided + which session to launch next.
